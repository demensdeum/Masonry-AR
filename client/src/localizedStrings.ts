export const localizedStrings: { [key: string]: { [key: string]: string } } = {
    "en" : {
        "WELCOME" : "Masons-AR is an augmented reality game that requires access to your geolocation.\nThe game uses cookies and closely monitors you in the name of the great lodge.\nBy clicking OK, you agree to this.",
    ...
    "ru" : {
        ...
        "WALK_CHALLENGE_MESSAGE" : "Здравствуй, масон! Я - Боров, свирепый представитель свинейного рода, и я бросаю тебе вызов: пройти пять километров! Думаешь, сможешь? Хрюкни громче, если смелость позволяет!"
    }
};